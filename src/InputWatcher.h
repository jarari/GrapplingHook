...
class InputWatcher : public RE::BSInputEventReceiver
{
public:
	typedef void (InputWatcher::*FnPerformInputProcessing)(const RE::InputEvent* a_queueHead);
	...
	void ProcessButtonEvent(RE::ButtonEvent* evn);

	void HookedPerformInputProcessing(const RE::InputEvent* a_queueHead);
